...
public class auth extends User
{
    ...
    public auth() {
        this.fileHandler_data =new FileHandling("C:\\Users\\t\\IdeaProjects\\FInal\\src\\Auth\\Users");
    }
    ...
    public boolean check(auth u) {
        ...
        for (String line : data) {
            ...
            if (UserData[1].equals(u.getUserName()) && UserData[2].equals(u.getPassword()) && UserData[3].equals(Integer.toString(u.getType()))) {
                c = true;
            }
        }
